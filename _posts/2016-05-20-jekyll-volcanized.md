...
![index.html](https://github.com/saleguas/jekyll-volcanized/raw/master/md/index.PNG)
...
![cards](https://github.com/saleguas/jekyll-volcanized/raw/master/md/cards.PNG)
The `cards.yml` has **3** basic options(you can add more of course) for the card cover and modal.

![config](https://github.com/saleguas/jekyll-volcanized/raw/master/md/config.PNG)
...
![modal](https://github.com/saleguas/jekyll-volcanized/raw/master/md/modal.PNG)
##  The `colors.yml` file
  * This one is pretty self-explanatory, it has an option to change the 10 base colors used and referenced by the CSS file.

![colors](https://github.com/saleguas/jekyll-volcanized/raw/master/md/colors.PNG)

## The `pages.yml` file

![pages.yml](https://github.com/saleguas/jekyll-volcanized/raw/master/md/pages.PNG)
...
![pages demonstration](https://github.com/saleguas/jekyll-volcanized/raw/master/md/pages.gif)

## The `social.yml` file

![social.yml](https://github.com/saleguas/jekyll-volcanized/raw/master/md/social.PNG)
...
[![Readme Card](https://github-readme-stats.vercel.app/api/pin/?username=saleguas&repo=jekyll-volcanized)](https://github.com/saleguas/jekyll-volcanized)